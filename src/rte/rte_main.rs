...
const CAM_RAW_CAPACITY: usize = 1116;
const CAM_PROCESSED_CAPACITY: usize = 1116;
const CAM_BIRD_EYE_CAPACITY: usize = 1114;
const CAM_LANE_ANGLE_CAPACITY: usize = 1118;
